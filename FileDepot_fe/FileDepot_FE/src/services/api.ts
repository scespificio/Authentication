...
export class ApiService {
        ...
        this.#axiosInstance.interceptors.request.use(
            (config) => {
                ...
                const isAuthEndpoint =
                    ...
                    url.startsWith("/core/auth/jwt/create");
    ...
    async login(email: string, password: string): Promise<UserData> {
        const response = await this.#axiosInstance.post<UserData>("/core/auth/jwt/create/", {
            "email": email,
            "password": password
        });
    ...
    async getConfig(): Promise<ConfigData> {
        const response = await this.#axiosInstance.get("/core/config/me/");
