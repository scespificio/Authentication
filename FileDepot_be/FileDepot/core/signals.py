...
#@receiver(user_activated, dispatch_uid="core.user_activated", weak=False)
...
#    via Djoser (qui utilisera core.emails.PasswordResetEmail selon tes settings).
#    """
#
...
#            ser.save()  # => appelle ta classe core.emails.PasswordResetEmail
