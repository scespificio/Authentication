...
#
env_path = r'/home/adminroot/services/env/FileDepot.dev.env'
...
WSGI_APPLICATION = 'FileDepot.wsgi.application'
...
DJOSER = {
    ...
    "SITE_NAME": "FileDepot",
    "EMAIL": {"activation": "core.emails.ActivationEmail",
...
CELERY_BROKER_URL = os.getenv("CELERY_BROKER_URL", "redis://filedepot-redis-broker:6379/0")
CELERY_RESULT_BACKEND = os.getenv("CELERY_RESULT_BACKEND", "redis://filedepot-redis-broker:6379/1")
